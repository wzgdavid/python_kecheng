...
#sns.violinplot(x="工作地点", y = '薪资', data = dfbox, hue='经验')
#plt.ylim(0,50000)
#plt.show()
...
##print(dfbox.head())
#plt.title('主要城市学历薪资分布')
#sns.violinplot(x="工作地点", y = '薪资', data = dfbox, hue='学历')
#plt.ylim(0,50000)
#plt.show()
...
#xueli = ['大专','本科','硕士']
#dfbox = df[df['工作地点'].isin(main_cities) & df['学历'].isin(xueli)]
#sns.violinplot(x="学历", y='薪资', data=dfbox, hue='工作地点', split=True)
#plt.ylim(0, 50000)
#plt.show()
#print(df.describe())
